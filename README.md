...
* **Логика переключения банков:**
  ...
  * **Управление адресацией ($A{18}\dots A{20}$):** 
    * Управляется линиями $A{18}\dots A{20}$ и записи в `REG(inst8)` , `REG(inst9)` выставляет нужный адрес на линии Flash-памяти $ROM\A18\dots ROM\A23$.
...
* **Элементная база:** **7 регистров**, **6 мультиплексоров** и поддержка памяти **FRAM / SRAM (32 КБ)**.
  ...
  * **Управление адресацией ($A{18}\dots A{20}$):** 
    * Управляется линиями $A{18}\dots A{20}$ и записи регистров `REG1``-``REG7` выставляет нужный адрес на линии Flash-памяти $ROM\A18\dots ROM\A23$.
