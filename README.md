...
* **Логика переключения банков:**
  ...
  * **Управление адресацией ($A_{18}\dots A_{20}$):** 
    * Управляется линиями $A_{18}\dots A_{20}$ и записи в `REG(inst8)` , `REG(inst9)` выставляет нужный адрес на линии Flash-памяти $ROM\_A18\dots ROM\_A23$.
